...
st.markdown("---")
st.header("📘 Indicator & Strategy Definitions (Fast Mode)")

with st.expander("📈 Strategy‑1: Swing Trading Indicators"):
    st.markdown("""
**EMA20** – Short‑term trend line.  
**EMA50** – Medium‑term trend line.  
...
**Distance to Support** – % distance from support.  
**Pullback to EMA20** – Price dips to EMA20 in uptrend.  
**Breakout Above 5‑Day High** – Momentum breakout.  
**Bullish Divergence** – RSI rising while price falling.  
**ADX** – Trend strength.  
**SPY Market Context** – Market trend.  
**VIX Condition** – Market fear level.
""")

with st.expander("📉 Strategy‑2: 52‑Week Drop Analyzer"):
    st.markdown("""
**52‑Week High** – Highest price in last 252 days.  
**Drop %** – How far stock is below 52‑week high.  
**Drop Buckets** – Groups stocks by drop %.
""")

with st.expander("🚀 Strategy‑3: Gap‑Up Day Trading"):
    st.markdown("""
**Yesterday Close** – Last price at 4 PM.  
**Premarket Close** – Last price before market opens.  
**Gap %** – Overnight price change.  
**Premarket Volume** – Volume from 4 AM to 9:29 AM.  
**Volume Ratio** – Premarket volume ÷ average volume.  
**News Catalyst** – Earnings, FDA, upgrade, etc.  
**Sector Strength** – Sector ETF direction.  
**SPY Futures %** – Market direction before open.  
**BUY / WATCH / IGNORE** – Signal based on score.  
**Score (0–100)** – Probability score.
""")



#REFINED GAPUP STRATEGY
